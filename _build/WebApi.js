...
const rm = require("typed-rest-client/_build/RestClient");
...
class WebApi {
    ...
    getCoreApi(isTfs, serverUrl, handlers) {
        return __awaiter(this, void 0, void 0, function* () {
            if (isTfs) {
                handlers = handlers || [this.authHandler];
    ...
    getTestApi(isTfs, serverUrl, handlers) {
        return __awaiter(this, void 0, void 0, function* () {
            if (isTfs) {
                handlers = handlers || [this.authHandler];
    ...
    getWorkApi(isTfs, serverUrl, handlers) {
        return __awaiter(this, void 0, void 0, function* () {
            if (isTfs) {
                handlers = handlers || [this.authHandler];
    ...
    getWorkItemTrackingApi(isTfs, serverUrl, handlers) {
        return __awaiter(this, void 0, void 0, function* () {
            if (isTfs) {
                handlers = handlers || [this.authHandler];
